    ...
    <section id="yetenekler" className="mx-auto max-w-[1100px] px-4 py-20">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {skills.map((sk) => (
          ...
          >
            <span className="pointer-events-none absolute -right-2 -top-3 z-10 scale-75 -rotate-12 rounded-lg border-[3px] border-ink bg-comic-red px-2 py-0.5 font-stamp text-sm text-white opacity-0 shadow-[2px_2px_0_#1a1a2e] transition-[opacity,transform] duration-200 group-hover:scale-100 group-hover:opacity-100">
              POW!
            </span>
